...
function Linux() {
  return (
    ...
    <>
      {/* Banner */}
      <header>
        <img src={images.linux_banner} alt="" className="w-[100%] object-cover h-full" />
      </header>

      {/* Oracle Linux Overview */}
      <div className="text-center my-20 w-full md:px-20 max-md:px-8">
        <InfoBloc
          title="Oracle Linux"
      ...
      {/* Operating System Section */}
       <div className='relative mb-40 max-md:mb-20'>
         <InfoBloc
          image={images.linux_os}
          imageClass='w-[100%] h-full object-contain'
          className='w-[15%] h-40 max-md:flex max-md:w-full md:hidden max'/>
        <InfoBloc
          title="Operating System"
          titleClass="text-4xl w-full text-center text-center text-blue-600 font-bold max-md:px-8 2xl:text-6xl"
        />
        <div className='flex gap-5 text-center w-[100%] max-md:flex-col'>
        <InfoBloc
          image={images.linux_os}
          imageClass='w-[100%] pl-5 h-full object-contain '
      ...
      {/* Support Section */}
       <div className='relative mb-40 max-md:mb-20'>
        ...
        <InfoBloc
          ...
          descriptionClass="text-sm mt-10 max-h-20 pb-50 text-left max-md:pb-40 max-md:text-center max-md:px-8 max-md:w-[100vw] text-black 2xl:text-xl"
          className='w-[75%] max-md:w-[100vw]'
          />
      </div>
      </div>
      ...
      {/* Red Hat Section */}
       ...
       <div className='relative mb-40 max-md:mb-90 2xl:mb-60 max-lg:mb-70'>
        <InfoBloc
          image={images.redhat}
          imageClass='w-[100%] h-full object-contain '
          className='w-[15%] h-40 max-md:flex max-md:w-full md:hidden'/>
        <InfoBloc 
          ...
          titleClass="text-4xl w-full text-center text-center text-blue-600 font-bold max-md:px-8 2xl:text-6xl"
        />
        <div className='flex gap-5 text-center w-[100%]'>
        <InfoBloc
          image={images.redhat}
          imageClass='w-[100%] pl-5 h-full object-contain'
